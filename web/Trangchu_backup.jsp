                                                    ...
                                                    <% if (khDangNhap !=null) {%>
                                                        <div class="header-user">
                                                            ...
                                                            <span>
                                                                ...
                                                                <small class="header-user-meta"><a
                                                                        href="Dangxuat.jsp">Đăng
                                                                        xuất</a></small>
                                                            </span>
                                                        </div>
                                                        <% } else { %>
                                        ...
                                        <div class="page-outer">
                                            ...
                                            <div class="site-shell">
                                                        ...
                                                        <ul class="category-list">
                                                            <li>
                                                                <a href="category.jsp?type=ssd">
                                                                    <span class="cat-icon"><svg viewBox="0 0 24 24"
                                                                    ...
                                                                    <span class="cat-label">SSD gắn trong (SATA,
                                                                        NVMe)</span>
                                                            ...
                                                            <li>
                                                                <a href="category.jsp?type=hdd2">
                                                                    ...
                                                                    <span class="cat-label">Ổ cứng HDD
                                                                        (PC/Laptop)</span>
                                                                    <span class="cat-chevron">›</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="category.jsp?type=storage">
                                                                    <span class="cat-icon"><svg viewBox="0 0 24 24"
                                                                            ...
                                                                            <path
                                                                                d="M4 14v2c0 2 3.5 4 8 4s8-2 8-4v-2" />
                                                                        </svg></span>
                                                                    <span class="cat-label">Ổ cứng di động
                                                                        (SSD/HDD)</span>
                                                                    <span class="cat-chevron">›</span>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <a href="category.jsp?type=lan_cable">
                                                                    ...
                                                                    <span class="cat-label">Phụ kiện mạng (LAN,
                                                                        adapter…)</span>
                                                                    <span class="cat-chevron">›</span>
                                                                </a>
                                                            </li>
                                                    ...
                                                    <section class="content-panel">
                                                        ...
                                                        <div class="hero-carousel" id="heroCarousel">
                                                            <div class="hero-banner">
                                                                ...
                                                                <div class="hero-slide hero-slide--nuphy"
                                                                    data-index="1">
                                                                    <div class="hero-copy">
                                                            ...
                                                            <div class="promo-strip" role="tablist"
                                                                ...
                                                                <button type="button" class="promo-tab active"
                                                                    role="tab" aria-selected="true" data-slide="0">
                                                        ...
                                                        <div class="promo-grid">
                                                            <a href="category.jsp?type=storage"
                                                                class="promo-card warm">Ổ CỨNG
                                                                DI ĐỘNG<span>Siêu bền — dung lượng lớn</span></a>
                                                            <a href="category.jsp?type=memory"
                                                                class="promo-card red">THẺ NHỚ
                                                                CHÍNH HÃNG<span>Giảm giá lên đến 30%</span></a>
                                                            <a href="category.jsp?type=keyboard"
                                                                class="promo-card orange">CHUỘT
                                                                — BÀN PHÍM — TAI NGHE<span>Ưu đãi combo theo
                                                                    mùa</span></a>
                                                        </div>

                                                        <section class="product-section" id="sanpham-noibat">
                                                            <div class="section-title-row">
                                                                <h2>SẢN PHẨM NỔI BẬT <% if (isAdmin) { %><span
                                                                            class="admin-badge">QUẢN TRỊ</span>
                                                                        <% } %>
                                                                </h2>
                                                                <span>Dữ liệu từ bảng tt_sanpham <% if (isAdmin) { %>-
                                                                        Chế độ quản trị<% } %></span>
                                                            </div>
                                                                    ...
                                                                    <% SanphamDAO sanphamDAO=new SanphamDAO();
                                                                        ...
                                                                        <div class="product-grid">
                                                                            <% if (danhSachSanpham !=null &&
                                                                                !danhSachSanpham.isEmpty()) { for
                                                                                (Sanpham sanpham : danhSachSanpham) {
                                                                                String
                                                ...
                                                <section class="product-section" id="tin-tuc">
                                                    ...
                                                    <div class="promo-grid">
                                                        <a href="Lienhe.jsp" class="promo-card warm">Build PC
                                                            2026<span>Tư vấn
                                                                cấu hình theo ngân sách</span></a>
                                                        <a href="Lienhe.jsp" class="promo-card red">Mẹo chọn
                                                            SSD<span>Tối ưu tốc
