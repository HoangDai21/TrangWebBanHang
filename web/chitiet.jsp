...
<%
    ...
    boolean isAdmin = (kh != null && "admin".equals(kh.getTendangnhap()));
...
<head>
    ...
    <title>Chi tiết sản phẩm - HĐStore</title>
                ...
                <section class="product-section">
                    ...
                    <div style="display:grid;grid-template-columns:minmax(240px,360px) 1fr;gap:18px;">
                        ...
                        <div>
                            ...
                            <p class="product-info"><strong>Phân loại:</strong> <%= product.getPhanloai() != null ? product.getPhanloai() : "Chưa phân loại" %></p>
                            <p class="product-info"><strong>Số lượng còn lại:</strong> <%= product.getSoluong() %></p>
                            ...
                            <% if (isAdmin) { %>
                                <div style="margin-top: 20px;">
                                    <a href="ThemSanpham.jsp" class="admin-btn admin-btn-add">➕ Thêm sản phẩm</a>
                                    <a href="SuaSanpham.jsp?id=<%= product.getMasp() %>" class="admin-btn admin-btn-edit">✏️ Sửa</a>
                                    <a href="XoaSanpham.jsp?id=<%= product.getMasp() %>" class="admin-btn admin-btn-delete" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?')">🗑️ Xóa</a>
                                </div>
                            <% } %>
                        </div>
                    </div>
