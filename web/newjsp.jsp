                                    ...
                                    <header class="top-header">
                                        <a href="Trangchu.jsp" class="brand-block">
                                            ...
                                            <div class="brand-text">
                                                <div class="brand-name"><span class="mem">HĐ</span><span
                                                        class="zone">Store</span></div>
                                                <div class="brand-tag">BY SIÊU TỐC</div>
                                            </div>
                                        </a>

                                        <form class="search-block" action="category.jsp" method="get">
                                            <input type="search" name="q" placeholder="Bạn cần tìm gì?"
                                                autocomplete="off">
                                            ...
                                            <div class="search-hints">Shop Router & Ổ Cứng · UltraDrive 1TB · Router
                                            ...
                                            <% if (khDangNhap !=null) {%>
                                                <div class="header-user">
                                                    ...
                                                    <span>
                                                        ...
                                                        <small class="header-user-meta"><a href="Dangxuat.jsp">Đăng
                                                                xuất</a></small>
                                                    </span>
                                                </div>
                                                <% } else { %>
                                ...
                                <div class="page-outer">
                                    ...
                                    <div class="site-shell">
                                        <main class="page-layout">
                                                ...
                                                <ul class="category-list">
                                                    <li>
                                                        <a href="category.jsp?type=ssd">
                                                            <span class="cat-icon"><svg viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <li>
                                                        <a href="category.jsp?type=usb">
                                                            <span class="cat-icon"><svg viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="1.6">
                                                                <path
                                                                    d="M12 2v6M9 8h6M10 8v12a2 2 0 002 2h0a2 2 0 002-2V8" />
                                                                </svg></span>
                                                    ...
                                                    <li>
                                                        <a href="category.jsp?type=nas">
                                                            ...
                                                            <span class="cat-label">NAS (Network Attached
                                                                Storage)</span>
                                                            <span class="cat-chevron">›</span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="category.jsp?type=router">
                                                            <span class="cat-icon"><svg viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="1.6">
                                                                <path
                                                                    d="M12 20v-2M8.5 9a7 7 0 0115 0M5.5 12a11 11 0 0117 0" />
                                                                </svg></span>
                                                    ...
                                                    <li>
                                                        <a href="category.jsp?type=lan_cable">
                                                            <span class="cat-icon"><svg viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="1.6">
                                                                <path
                                                                    d="M8 8h8v8H8zM4 12h4M16 12h4M12 4v4M12 16v4" />
                                                                </svg></span>
                                            ...
                                            <section class="content-panel">
                                                ...
                                                <div class="hero-carousel" id="heroCarousel">
                                                    <div class="hero-banner">
                                                        <div class="hero-slide active hero-slide--pc" data-index="0">
                                                            <div class="hero-copy">
                                                                ...
                                                                <p>Ưu đãi Office, Windows 11 Pro và phụ kiện đi kèm —
                                                                    sẵn hàng giao nhanh tại MemoryZone.</p>
                                                                <div class="hero-actions-row">
                                                                    <a href="#sanpham-noibat" class="hero-primary">NHẬN
                                                                        NGAY</a>
                                                        ...
                                                        <div class="hero-slide hero-slide--nuphy" data-index="1">
                                                            <div class="hero-copy">
                                                                ...
                                                                <p>Thiết kế mỏng nhẹ, layout đa dạng, phù hợp làm việc
                                                                    và chơi game.</p>
                                                                <div class="hero-actions-row">
                                                                    <a href="#sanpham-noibat" class="hero-primary">KHÁM
                                                                        PHÁ</a>
                                                        ...
                                                        <div class="hero-slide hero-slide--sandisk" data-index="2">
                                                            <div class="hero-copy">
                                                                ...
                                                                <p>Ổ di động &amp; thẻ nhớ phiên bản giới hạn, tốc độ
                                                                    cao cho game thủ.</p>
                                                                <div class="hero-actions-row">
                                                                    <a href="#sanpham-noibat" class="hero-primary">MUA
                                                                        NGAY</a>
                                                                </div>
                                                            </div>
                                                            <div class="hero-visual" aria-hidden="true"></div>
                                                        ...
                                                        <div class="hero-slide hero-slide--corsair" data-index="3">
                                                            <div class="hero-copy">
                                                                ...
                                                                <p>Switch quang, đèn RGB đồng bộ iCUE, phím macro tùy
                                                                    chỉnh.</p>
                                                                <div class="hero-actions-row">
                                                                    <a href="#sanpham-noibat" class="hero-primary">XEM
                                                                        COMBO</a>
                                                                </div>
                                                            </div>
                                                            <div class="hero-visual" aria-hidden="true"></div>
                                                        ...
                                                        <div class="hero-slide hero-slide--rtx" data-index="4">
                                                            <div class="hero-copy">
                                                                ...
                                                                <p>Hiệu năng AI &amp; ray tracing thế hệ mới — đủ cho 4K
                                                                    và VR.</p>
                                                                <div class="hero-actions-row">
                                                                    <a href="#sanpham-noibat" class="hero-primary">ĐẶT
                                                                        TRƯỚC</a>
                                                                </div>
                                                            </div>
                                                            <div class="hero-visual" aria-hidden="true"></div>
                                                    ...
                                                    <div class="promo-strip" role="tablist"
                                                        aria-label="Chọn banner khuyến mãi">
                                                        <button type="button" class="promo-tab active" role="tab"
                                                            aria-selected="true" data-slide="0">
                                                            <span class="tab-title">PC Siêu Tốc</span>
                                                            <span class="tab-sub">Ưu đãi độc quyền</span>
                                                        </button>
                                                        <button type="button" class="promo-tab" role="tab"
                                                            aria-selected="false" data-slide="1">
                                                        ...
                                                        <button type="button" class="promo-tab" role="tab"
                                                            aria-selected="false" data-slide="4">
                                                ...
                                                <div class="promo-grid">
                                                    <a href="category.jsp?type=storage" class="promo-card warm">Ổ CỨNG
                                                        DI ĐỘNG<span>Siêu bền — dung lượng lớn</span></a>
                                                    <a href="category.jsp?type=memory" class="promo-card red">THẺ NHỚ
                                                        CHÍNH HÃNG<span>Giảm giá lên đến 30%</span></a>
                                                    <a href="category.jsp?type=keyboard" class="promo-card orange">CHUỘT
                                                        — BÀN PHÍM — TAI NGHE<span>Ưu đãi combo theo mùa</span></a>
                                                </div>
                                                ...
                                                <section class="product-section" id="sanpham-noibat">
                                                    ...
                                                    <% SanphamDAO sanphamDAO=new SanphamDAO(); List<Sanpham>
                                                        ...
                                                        <div class="product-grid">
                                                            <% if (danhSachSanpham !=null && !danhSachSanpham.isEmpty())
                                                                { for (Sanpham sanpham : danhSachSanpham) { String
                                                                giaHienThi=dinhDangTien.format(sanpham.getGia()).replace(',', '.'
                                                                ...
                                                                <article class="product-card"
                                                                    ...
                                                                    <% if (hinhAnh !=null && !hinhAnh.trim().isEmpty())
                                                                        ...
                                                                        <% } else { %>
                                                                            <div class="product-placeholder">Chưa có
                                                                                hình ảnh</div>
                                                                            <% }%>
                                                                                <div class="product-body">
                                                                                    ...
                                                                                    <p class="product-info"><strong>Phân
                                                                                            loại:</strong>
                                                                                        <%= sanpham.getPhanloai() !=null
                                                                                            ? sanpham.getPhanloai()
                                                                                            : "Chưa phân loại" %>
                                                                                    </p>
                                                                ...
                                                                <% } } else { %>
                                                                    <div class="empty-state">Chưa có sản phẩm nào trong
                                                                        bảng tt_sanpham.</div>
                                                                    <% }%>
                                                        </div>
                                                </section>
                                            ...
                                            <aside class="right-rail">
                                                <div class="rail-card rail-top">PC SIÊU TỐC<span>Giá tốt &amp; sẵn hàng
                                                        tại MemoryZone</span></div>
                                                <div class="rail-card rail-mid">NHẬN NGAY<span>Office, Windows, bàn phím
                                                        &amp; chuột</span></div>
                                                <div class="rail-card rail-bottom">ƯU ĐÃI<span>Khám phá sản phẩm mới mỗi
                                                        ngày</span></div>
                                            </aside>
                                        </main>
                                        ...
                                        <section class="product-section" id="tin-tuc">
                                            ...
                                            <div class="promo-grid">
                                                <a href="Lienhe.jsp" class="promo-card warm">Build PC 2026<span>Tư vấn
                                                        cấu hình theo ngân sách</span></a>
                                                <a href="Lienhe.jsp" class="promo-card red">Mẹo chọn SSD<span>Tối ưu tốc
                                                        độ cho laptop và desktop</span></a>
                                                <a href="Lienhe.jsp#tuyendung" class="promo-card orange">Tuyển
                                                    dụng<span>Gia nhập đội ngũ kỹ thuật viên</span></a>
                                            </div>
                                        </section>
