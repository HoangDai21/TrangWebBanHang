...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (maspStr == null || tensp == null || giaStr == null || phanloai == null || thongtin == null ||
            maspStr.isEmpty() || tensp.isEmpty() || giaStr.isEmpty() || phanloai.isEmpty() ||
            thongtin.isEmpty()) {
            ...
            try {
                ...
                if (gia < 0) {
                    ...
                    Sanpham existing = dao.laySanphamTheoId(masp);
                    ...
                    if (existing != null) {
                        ...
                        sp.setSoluong(existing.getSoluong());
                        ...
                        sanpham = dao.laySanphamTheoId(masp);
                    } else {
    ...
    // Lay thong tin san pham neu chua co (GET hoac co id)
    if (sanpham == null && productId != null) {
        try {
            int id = Integer.parseInt(productId);
            SanphamDAO dao = new SanphamDAO();
            sanpham = dao.laySanphamTheoId(id);
        } catch (Exception e) {
            response.sendRedirect("Trangchu.jsp");
            return;
        }
...
<body>
    <div class="admin-container">
        <div class="admin-header">
            <h1>SỬA SẢN PHẨM <span class="admin-badge">ADMIN</span></h1>
        ...
        <div class="product-info">
            ...
            ID: <%= sanpham.getMasp() %> | Tên: <%= sanpham.getTensp() %> | Giá: <%= sanpham.getGia() %> VNĐ
        </div>
        ...
        <form method="post" action="SuaSanpham.jsp?id=<%= sanpham.getMasp() %>">
            ...
            <div class="form-group">
                ...
                <select id="phanloai" name="phanloai" required>
                    ...
                    <option value="RAM DDR2" <%="RAM DDR2".equals(sanpham.getPhanloai()) ? "selected" : "" %>>RAM DDR2</option>
                    <option value="RAM DDR3" <%="RAM DDR3".equals(sanpham.getPhanloai()) ? "selected" : "" %>>RAM DDR3</option>
                    <option value="RAM DDR4" <%="RAM DDR4".equals(sanpham.getPhanloai()) ? "selected" : "" %>>RAM DDR4</option>
                    <option value="RAM DDR5" <%="RAM DDR5".equals(sanpham.getPhanloai()) ? "selected" : "" %>>RAM DDR5</option>
            ...
            <div class="form-group">
                ...
                <small style="color: #666;">Nhập đường dẫn hình ảnh</small>
            </div>
